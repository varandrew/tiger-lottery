...
// baseContractPath: relative path of the base contract, i.e. "./contracts/Lottery.sol"
const instantiateContract = (baseContractPath) => {
  ...
  const bytecode =
    "0x" + contract.contracts[baseContractPath]["Lottery"].evm.bytecode.object;
  const abi = contract.contracts[baseContractPath]["Lottery"].abi;
  return {
    bytecode: bytecode,
    abi: abi,
  };
